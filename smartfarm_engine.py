...
CAPEX_MAJOR_EVIDENCE_STATUS = {
    ...
    "greenhouse_structure": "실측(5건: 우민재·최혁진·이두희·윤성호·한일그린텍)",
    "auto_opening_system": "실측(5건: 우민재·최혁진·이두희·윤성호·한일그린텍 — 보온커튼·스크린은 구동부와 함께 "
                           "이 카테고리 소속으로 확정, 2026-08-17 사용자 결정(우민재 방식 통일). "
                           "종전 표기 '모터·보온재 미분리'는 문제가 아니라 관례로 승격)",
    "hvac": "실측(3건: 우민재·최혁진·윤성호 — 이두희·한일그린텍은 견적 범위에 난방설비 자체가 없어 0. "
            "한일그린텍은 유동휀·배출환풍기가 실재하나 '환급금 재투자' 블록이라 직접공사비 분모 밖)",
    "irrigation_fertigation": "실측(5건: 우민재·최혁진·이두희·윤성호·한일그린텍)",
    "ict_control": "실측(3건: 최혁진·이두희·윤성호 — 우민재·한일그린텍은 독립 환경제어시스템 라인 없음(0). "
                   "한일그린텍 하우스콘트롤 7,434,000원은 개폐 접점 제어반이라 자동개폐 소속)",
    "electrical": "실측(2건: 최혁진·윤성호 — 우민재·이두희·한일그린텍은 별도 전기공사 공종 없음(0), "
