...
CAPEX_MAJOR_EVIDENCE_STATUS = {
    "greenhouse_structure": "실측(2건)",
    "auto_opening_system": "실측(4건: 우민재·최혁진·이두희·윤성호 — 보온커튼·스크린은 구동부와 함께 "
...
#   둘 다 정확하다. 나머지 4건(공주장원리·한일그린텍·당진이상근·원채원)은 A-11
#   지침값으로 원문 미보유 — 단, 공주장원리는 2026-08-17 P2-17 중 원문 후보 발견:
#   견적참조/산출내역서(본)_250630.pdf(이동혁, 공주시 정안면 장원리, 3,759㎡ 정확
#   일치, 그린팜스글로벌 2025-05 견적)의 총공사원가 448,000,000(VAT포함 십만이하
#   절사) vs 등록값 450,000,000 — 0.4% 차이. 견적서(유효 14일)라 최종 계약금액인지
#   단정 불가해 값은 유지, 계약서·정산서 확보 시 재검토.
# ─────────────────────────────────────────────────────────────
# (하한, 상한) 원/㎡
BENCHMARK_BANDS = {
...
#   · 전기(건축물 전기설비) 1년 — 전기공사업법 시행령 별표3의2. ⚠️ 2차 출처
#     (04noti 정리표)로만 확인, 원문 별표 파일 미확보 [확인요망]
#   · 통신(그 외 정보통신공사) 1년 — 정보통신공사업법 시행령 제37조(통신구 5년·
#     케이블/관로/철탑/교환기/전송/위성 3년·그 외 1년). ⚠️ 웹검색 조문 요약으로
#     확인, 원문 재확인 권장 [확인요망]
WARRANTY_STATUTORY = {
    ...
    "전기(건축물 전기설비)": {"years": 1, "근거": "전기공사업법 시행령 별표3의2 [확인요망: 2차출처]"},
    "통신(그 외 정보통신공사)": {"years": 1, "근거": "정보통신공사업법 시행령 제37조 [확인요망: 조문 요약]"},
}
