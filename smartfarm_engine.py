...
CAPEX_MAJOR_EVIDENCE_STATUS = {
    ...
    "thermal_storage_insulation": "부분실측(축열탱크만 1건: 윤성호 축열조 90ton 41,958,000원 라인분리, 2026-08-17 P2-17. "
                                  "보온커튼은 여전히 자동개폐와 미분리 — 분리견적 참고근거로 이동혁(공주) 산출내역서 "
                                  "'3.다겹보온커튼 공사' 59,948,820원/1,139평(커튼모터·자동개폐기 포함 일체)을 확보했으나, "
                                  "커튼을 8번으로 옮기면 우민재(자동개폐에 커튼 포함)와 분류가 갈라져 판단성 보류)",
...
CAPEX_MAJOR_CASE_CHUNKS = {
    ...
    #      라인을 분리(최혁진 0113 환경제어 라인분리와 동일 방식). 보온커튼은
    #      여전히 0108 수평스크린(자동개폐)과 미분리 — 기존 관례 유지.
    ...
    "윤성호": {
        ...
        "auto_opening_system": 110592840,    # 0107천창개폐(25,657,502)+0108수평스크린(84,935,338) — 보온스크린 포함, 미분리 관례 유지
