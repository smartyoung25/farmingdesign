...
CAPEX_MAJOR_EVIDENCE_STATUS = {
    ...
    # 이후 표본 추가 차수는 이 건수도 같은 차수에 동기한다(52차 이준희·55차 맹주연 반영 — 7표본).
    "greenhouse_structure": "실측(7건: 우민재·최혁진·이두희·윤성호·한일그린텍·이준희·맹주연)",
    "auto_opening_system": "실측(7건: 우민재·최혁진·이두희·윤성호·한일그린텍·이준희·맹주연 — 보온커튼·스크린은 구동부와 함께 "
                           "이 카테고리 소속으로 확정, 2026-08-17 사용자 결정(우민재 방식 통일). "
                           "종전 표기 '모터·보온재 미분리'는 문제가 아니라 관례로 승격)",
    "hvac": "실측(5건: 우민재·최혁진·윤성호·이준희[유동휀만 — 난방설비는 '본 공사제외']·맹주연[유동팬 42대·환풍기 "
            "6대·설치노무 — 010108 혼재 공종에서 명시 라인 분리] — 이두희·한일그린텍은 견적 범위에 난방설비 "
            "자체가 없어 0. 한일그린텍은 유동휀·배출환풍기가 실재하나 '환급금 재투자' 블록이라 직접공사비 분모 밖)",
    "irrigation_fertigation": "실측(7건: 우민재·최혁진·이두희·윤성호·한일그린텍·이준희·맹주연)",
    "ict_control": "실측(4건: 최혁진·이두희·윤성호·이준희 — 우민재·한일그린텍·맹주연은 독립 환경제어시스템 라인 없음(0): "
                   "한일그린텍 하우스콘트롤 7,434,000원·맹주연 컨트롤박스 5,400,000원은 개폐 제어반이라 자동개폐 "
                   "소속. 이준희 83,463,440원은 표본 최대 관측치 — 원인은 제어기 브랜드/패키지(PRIVA Compact CC "
                   "80,000,000원이 95.85%, 기존 3건은 국산 마그마 계열 — 54차 5회차 F1 귀속 정정))",
    "electrical": "실측(3건: 최혁진·윤성호·이준희 — 우민재·이두희·한일그린텍·맹주연은 별도 전기공사 공종 없음(0), "
