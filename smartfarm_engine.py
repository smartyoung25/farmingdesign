...
CAPEX_MAJOR_EVIDENCE_STATUS = {
    ...
    # 이후 표본 추가 차수는 이 건수도 같은 차수에 동기한다(52차 이준희·55차 맹주연·56차 강정구 — 8표본).
    "greenhouse_structure": "실측(8건: 우민재·최혁진·이두희·윤성호·한일그린텍·이준희·맹주연·강정구)",
    "auto_opening_system": "실측(8건: 우민재·최혁진·이두희·윤성호·한일그린텍·이준희·맹주연·강정구 — 보온커튼·스크린은 구동부와 함께 "
    ...
    "hvac": "실측(5건: 우민재·최혁진·윤성호·이준희[유동휀만 — 난방설비는 '본 공사제외']·맹주연[유동팬 42대·환풍기 "
            "6대·설치노무 — 010108 혼재 공종에서 명시 라인 분리] — 이두희·한일그린텍·강정구는 견적 범위에 난방설비 "
            "자체가 없어 0. 한일그린텍은 유동휀·배출환풍기가 실재하나 '환급금 재투자' 블록이라 직접공사비 분모 밖, "
            "강정구는 부분 범위 견적[골조·개폐·피복만])",
    "irrigation_fertigation": "실측(7건: 우민재·최혁진·이두희·윤성호·한일그린텍·이준희·맹주연 — 강정구는 부분 범위 "
                              "견적이라 관수·양액 품목 전무(0))",
    "ict_control": "실측(4건: 최혁진·이두희·윤성호·이준희 — 우민재·한일그린텍·맹주연·강정구는 독립 환경제어시스템 라인 없음(0): "
                   ...
                   "54차 5회차 F1 귀속 정정))",
    "electrical": "실측(3건: 최혁진·윤성호·이준희 — 우민재·이두희·한일그린텍·맹주연·강정구는 별도 전기공사 공종 없음(0), "
