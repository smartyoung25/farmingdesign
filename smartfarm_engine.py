...
CAPEX_MAJOR_EVIDENCE_STATUS = {
    ...
    # 이후 표본 추가 차수는 이 건수도 같은 차수에 동기한다(52차 이준희·55차 맹주연·56차 강정구·57차 오기수·59차 백가은·조윤정·60차 박규현 — 11표본).
    "greenhouse_structure": "실측(10건: 우민재·최혁진·이두희·윤성호·한일그린텍·이준희·맹주연·강정구·백가은·조윤정·박규현 — 오기수는 설비 전용 "
                            "부분 범위 견적이라 골조·피복 품목 전무(0))",
    "auto_opening_system": "실측(11건: 전 표본 — 보온커튼·스크린은 구동부와 함께 "
    ...
    "hvac": "실측(7건: 우민재·최혁진·윤성호·이준희[유동휀만 — 난방설비는 '본 공사제외']·맹주연[유동팬 42대·환풍기 "
            ...
            "유동휀 24대] — 이두희·한일그린텍·강정구·오기수는 견적 범위에 난방설비 자체가 없어 0. "
            "한일그린텍은 유동휀·배출환풍기가 실재하나 '환급금 재투자' 블록이라 직접공사비 분모 밖, "
            "강정구·오기수는 부분 범위 견적[각각 골조 쪽만·설비 쪽만 — 오기수는 유동휀·배기휀 '단자'만 예비])",
    "irrigation_fertigation": "실측(10건: 우민재·최혁진·이두희·윤성호·한일그린텍·이준희·맹주연·오기수·백가은·조윤정·박규현 — 강정구는 부분 범위 "
                              "견적이라 관수·양액 품목 전무(0))",
    "ict_control": "실측(5건: 최혁진·이두희·윤성호·이준희·오기수 — 우민재·한일그린텍·맹주연·강정구·백가은·조윤정·박규현은 독립 환경제어시스템 라인 없음(0): "
    ...
    "electrical": "실측(4건: 최혁진·윤성호·이준희·박규현[전기 공종 잔여 2,832,665 — 케이블·잡자재·인건비, 공종의 제어기·팬은 "
                  "실체 분리] — 우민재·이두희·한일그린텍·맹주연·강정구·오기수·백가은·조윤정은 별도 전기공사 공종 없음(0), "
